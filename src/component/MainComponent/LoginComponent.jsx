                                        ...
                                        <div className="login-form">
                                            ...
                                            <form>
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <a href="forgot-password.html" className="forgot-link d-flex align-items-center justify-content-end">forgot password?</a>
                                                </div>
                                                
                                                <button type="submit" className="btn btn-login w-100">Login</button>
                                            </form>
                                            <p className="mb-0 signup-link text-center">Don’t have an account yet? <a href="signup.html" className="forgot-link">SignUp</a></p>
                                        </div>
