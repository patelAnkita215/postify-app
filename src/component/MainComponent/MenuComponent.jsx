    ...
    return(
        <>
            <ul className="nav">
              ...
              <li className="nav-item">
                <Link to="/message" className="nav-link" activeClassName="active">
              ...
              <li className="nav-item">
                <Link to="/notification" className="nav-link" activeClassName="active">
              ...
              <li className="nav-item">
                <Link to="/setting" className='nav-link' activeClassName="active">
